...
def states_list():
    """Route that display a HTML page with a list of states objects sorted by name."""
...
def cities_by_states():
    """Post a HTML page with a list of cities objects sorted by name."""
...
def teardown_appcontext(exception):
    """Remove the current SQL Alchemy Session after each request."""
    storage.close()
